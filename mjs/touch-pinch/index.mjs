...
import {distance as getDistance} from "/gl-vec2/distance.mjs";
//var EventEmitter = require('events').EventEmitter
import {EventEmitter} from "/events/events.mjs";
//var dprop = require('dprop')
import {defaultProperty as dprop} from "/dprop/index.mjs";
//var eventOffset = require('mouse-event-offset')
import {mouseEventOffset as eventOffset} from "/mouse-event-offset/index.mjs";

//module.exports = touchPinch
export function touchPinch (target) {
